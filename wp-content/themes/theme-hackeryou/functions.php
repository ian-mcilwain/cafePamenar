...
function theme_setup() {
	...
	*  sizes with add_image_size. */
	...
	add_image_size('custom', 1600, '', true);
...
function hackeryou_widgets_init() {
	...
	register_sidebar( array(
		...
		'id' => 'logo-widget-area',
		'description' => 'The logo widget area',
		'before_widget' => '',
		'after_widget' => '',
		'before_title' => '',
		'after_title' => '',
		...
		register_sidebar( array(
		'name' => 'title Widget Area',
		'id' => 'title-widget-area',
		'description' => 'The logo widget area',
		'before_widget' => '',
		'after_widget' => '',
		'before_title' => '',
		...
		register_sidebar( array(
		'name' => 'Wine Menu Widget Area',
		'id' => 'wine-menu-widget-area',
		'description' => 'The logo widget area',
		'before_widget' => '<li class="menuWidget">',
		'after_widget' => '</li>',
		'before_title' => '',
		'after_title' => '',
	) );
		...
		register_sidebar( array(
		'name' => 'Beer Menu Widget Area',
		'id' => 'beer-menu-widget-area',
		'description' => 'The logo widget area',
		'before_widget' => '<li class="menuWidget">',
		'after_widget' => '</li>',
		'before_title' => '',
		'after_title' => '',
			...
			register_sidebar( array(
		'name' => 'Food Menu Widget Area',
		'id' => 'food-menu-widget-area',
		'description' => 'The logo widget area',
		'before_widget' => '<li class="menuWidget">',
		'after_widget' => '</li>',
		'before_title' => '',
		'after_title' => '',
			...
			register_sidebar( array(
		'name' => 'Cofffee Menu Widget Area',
		'id' => 'coffee-menu-widget-area',
		'description' => 'The logo widget area',
		'before_widget' => '<li class="menuWidget">',
		'after_widget' => '</li>',
		'before_title' => '',
		'after_title' => '',
			...
			register_sidebar( array(
		'name' => 'openTable Menu Widget Area',
		'id' => 'openTable-widget-area',
		'description' => 'The logo widget area',
		'before_widget' => '<li class="menuWidget">',
		'after_widget' => '</li>',
		'before_title' => '',
